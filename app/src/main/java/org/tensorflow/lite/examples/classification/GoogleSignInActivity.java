                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (isNewUser) {
                                ...
                                myRef.child(uid).child("butterfly").setValue(false);
                                myRef.child(uid).child("dog").setValue(false);
                                myRef.child(uid).child("cat").setValue(false);
                                myRef.child(uid).child("squirrel").setValue(false);
                                myRef.child(uid).child("spider").setValue(false);
                            }
